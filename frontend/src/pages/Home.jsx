            ...
            <div className="mt-6 flow-root text-black">
              <div className="-my-6 divide-y divide-gray-500/10">
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-black dark:text-white hover:border hover:border-black"
                    >
                      {item.name}
                    </a>
                  ))}
                ...
                <div className="py-6">
                  <a
                    href="#"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-black  dark:text-white hover:border hover:border-black"
                  >
                    Log in
                  </a>
                </div>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/5">
              We provide career roadmaps, preparation
              guidance, resume reviews, interview experiences, and much more to
